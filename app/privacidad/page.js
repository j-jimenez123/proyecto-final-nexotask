      ...
      <section className={styles.layout}>
        ...
        <div className={styles.panel}>
          <article id="responsable">
            ...
            <p>
              El responsable de este proyecto académico es Juan Francisco
              Jiménez Bautista, alumno de 2.º DAW. NexoTask se ha desarrollado
              como proyecto final de clase y su uso está pensado para una demo
              educativa.
            </p>
          </article>
          ...
          <article id="datos-tratados">
            ...
            <p>
              La aplicación puede guardar nombre, correo electrónico, datos de
              sesión y las tareas creadas por el usuario. Las contraseñas no se
              guardan en texto plano, ya que la autenticación se gestiona con
              better-auth. No se solicitan datos bancarios, direcciones postales
              ni información sensible que no sea necesaria para usar el gestor.
            </p>
          </article>
          ...
          <article id="finalidad">
            ...
            <p>
              Los datos se usan para permitir el registro, inicio de sesión,
              acceso al dashboard y gestión de tareas personales dentro de la
              aplicación.
            </p>
          </article>
          ...
          <article id="base-de-legitimacion">
            ...
            <p>
              ...
              la cuenta y aceptar esta política de privacidad.
            </p>
          </article>
          ...
          <article id="conservacion">
            ...
            <p>
              ...
              necesarios para el funcionamiento de la demo académica. En un
          ...
          <article id="seguridad">
            ...
            <p>
              ...
              cuenta pueda acceder a tareas de otra. Además, el repositorio no
          ...
          <article id="derechos">
            ...
            <p>
              En un entorno real, el usuario podría solicitar acceso,
              rectificación o eliminación de sus datos. En este proyecto, al
              ser académico, estos derechos se simulan a nivel funcional.
            </p>
          </article>
